...
export declare class ContextParser {
  ...
  validateKeywordRedefinitions(
    contextBefore: IJsonLdContextNormalizedRaw,
  ...
  getOverriddenLoad(
    url: string,
    options: IParseOptions,
  ): IJsonLdContextNormalizedRaw | null;
  /**
   * Load an @import'ed context.
   * @param importContextIri The full URI of an @import value.
   */
  loadImportContext(
    importContextIri: string,
  ): Promise<IJsonLdContextNormalizedRaw>;
}
